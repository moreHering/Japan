-- 0013 · Kurzlink-Auflöser: Kopfzeilen so, wie pgsql-http 1.6 sie kann
--
-- 0012 rief `http_headers('Cookie', …, 'Accept-Language', …)` auf. Diese
-- Funktion gibt es erst ab pgsql-http 1.7; Supabase liefert 1.6, und der
-- Probeschritt in migrate.yml meldete am 26.09.2026:
--   function http_headers(unknown, unknown, unknown, unknown) does not exist
-- Lokal fiel das nicht auf, weil der Test-Postgres die Erweiterung gar nicht
-- hat. Hier dieselbe Funktion mit `array[http_header(…), …]`, sonst unverändert.
